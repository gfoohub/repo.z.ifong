...
# burn it into CD
# boot with the DSL 3.0.1 live CD (when booting just ENTER, DO NOT USE dsl toram, since it cannot be loaded into ram )
# 
#dsl@box:~$ sudo su
...
dd if=/dev/zero of=/tmp/initrd.img bs=1024 count=120000
