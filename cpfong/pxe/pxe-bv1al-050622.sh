...
#
# 1st boot with bv1al CD,when booting just ENTER, DO NOT USE dsl toram, since it cannot be loaded into ram
# 
#dsl@box:~$ sudo su
#bash-2.05b# wget http://center.fotech.edu.tw/~cpfong/pxe/pxe-bv1al-050622.sh
#bash-2.05b# bash ./pxe-bv1al-050622.sh
#
#
...
dd if=/dev/zero of=/tmp/initrd.img bs=1024 count=130000
