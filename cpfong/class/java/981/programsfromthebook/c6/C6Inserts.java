...
public class C6Inserts extends JFrame implements ActionListener {
    ...
    //------------ENDEXTRACT=dectimerlongway.xtr
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //---------------------STARTEXTRACT=tfmethods.xtr
        String s;
        s = textField1.getText();
        textField1.setText(s);
        //---------------------ENDEXTRACT=tfmethods.xtr
//----------------STARTEXTRACT=imagequotedstring.xtr
        ImageIcon myImage = new ImageIcon("c:\\temp\\imageDemo.jpg");
//------------------ENDEXTRACT=imagequotedstring.xtr
