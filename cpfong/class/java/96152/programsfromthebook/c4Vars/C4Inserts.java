...
public void noconstants() {
//-------------STARTEXTRACT=nofinal.xtr
double miles, km = 4.7;
miles = km * 0.6214;
//----------------ENDEXTRACT=nofinal.xtr
}

public void useconstants() {

//---------------STARTEXTRACT=usefinal.xtr
final double milesPerKm = 0.6214;
double miles, km = 4.7;
miles = km * milesPerKm;
//------------------ENDEXTRACT=usefinal.xtr

//-------------------STARTEXTRACT=mathpi.xtr
double radius = 1.4, circumference;
circumference = 2 * Math.PI * radius;
//------------------ENDEXTRACT=mathpi.xtr

//---------------------STARTEXTRACT=finalstq.xtr
final double cmPerInch = 2.54;
double cm, inches = 23.6;
cm = inches * cmPerInch;
//----------------------------ENDEXTRACT=finalstq.xtr
 ...
 //----------STARTEXTRACT=stringexpression.xtr
   int age;
   age = Integer.parseInt(JOptionPane.showInputDialog(null,
                                      "Enter age"));
//------------------ENDEXTRACT=stringexpression.xtr
    ...
    private void testInit() {
        ...
        double d;
        int n;
         //     n=i;     //no - comp err-says i is not init
        //      s2=s;     // no - same as int
        i=privateInt;
