...
public class Telephone extends JFrame implements ActionListener {
    ...
    private void createGUI() {
        ...
        button = new JButton("find");window.add(button);button.addActionListener(this);

        name   = new JTextField(6);window.add(name);
        number = new JTextField(14);window.add(number);

        names[0] = "Alex" ;numbers[0] = "2720774";
        names[1] = "Megan";numbers[1] = "5678554";
        names[2] = "END"  ;
    }
	...
	index=0;
	while (1==1){
		if ( names[index].equals("END") || names[index].equals(wanted) ) {
			break;
		}
		index++;
	}
