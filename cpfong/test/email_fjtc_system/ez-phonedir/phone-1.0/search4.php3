...
$sql="SELECT * FROM address WHERE lower(name) LIKE lower('$name%') order by last;";
$sql2="SELECT count(*) from address WHERE lower(name) LIKE lower('$name%');";
...
?>
<tr><th bgcolor=#608080 align=center COLSPAN=3><font color=white>End Of Search Results</th></tr>
</table>
<br>
<center>
<table>
