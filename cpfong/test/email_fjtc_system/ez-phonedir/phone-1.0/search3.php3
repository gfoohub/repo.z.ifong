...
$sql="SELECT * FROM address WHERE lower(city) LIKE lower('$name%') order by last;";
$sql2="SELECT count(*) from address WHERE lower(city) LIKE lower('$name%');";
...
if ((!$result_set) || ($rows < 1)) {
       ...
       echo "<H1>Sorry the listing for City $name was not found. Please redo your search. </H1><P>";
       echo "<table>";
