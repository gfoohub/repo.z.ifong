...
$sql="SELECT * FROM address WHERE lower(notes) LIKE lower('$name%')order by last;";
$sql2="SELECT count(*) from address WHERE lower(notes) LIKE lower('$name%');";
...
if ((!$result_set) || ($rows < 1)) {
       ...
       echo "<H1>Sorry $name was not found in any notes. Please redo your search. </H1><P>";
       echo "<table>";
...
echo "<tr><th align=left><a href=search7.php3?name=$pos16>View Full Record</a></th><td align=left>$pos $pos2</td><td>Phone: ( $pos18 ) $pos3</td><td>Notes: &nbsp $pos15</td></tr>";
 }
}
?>
<tr><th bgcolor=#608080 align=center COLSPAN=4><font color=white>End Of Search Results</th></tr>
</table>
<br>
<center>
<table>
