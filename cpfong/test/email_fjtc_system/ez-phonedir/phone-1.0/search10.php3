...
$sql="SELECT * FROM address WHERE lower(anniversay) LIKE lower('$name%') order by last;";
$sql2="SELECT count(*) from address WHERE lower(anniversay) LIKE lower('$name%');";
...
echo "<tr><th align=left><a href=search7.php3?name=$pos16>View Full Record</a></th><td align=left>$pos $pos2 </td><td> Anniversary: $pos24 </td><td> Phone:( $pos18 ) $pos3</td><td>Email:$pos11</td></tr>";
 }
}
?>
