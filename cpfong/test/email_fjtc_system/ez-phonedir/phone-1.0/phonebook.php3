...
$sql="SELECT * FROM address ORDER BY last;";
$sql2="SELECT count(*) from address;";
...
if ((!$result_set) || ($rows < 1)) {
       ...
       echo "<center>";
       echo "<H2>Sorry your EZ Phone Directory is empty. Please add listings before trying to view the database. </H2><P>";
       echo "<table>";
...
?>
<tr><th bgcolor=#608080 align=center COLSPAN=5><font color=white>End Of Listings</th></tr>
</table>
<br>
<center>
<table>
